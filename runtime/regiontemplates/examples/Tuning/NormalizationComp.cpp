...
int NormalizationComp::run() {
    ...
    ArgumentFloatArray *args = ((ArgumentFloatArray *)
            this->getArgument(1));
...
bool registeredN = PipelineComponentBase::ComponentFactory::componentRegister("NormalizationComp",
                                                                              &componentFactoryNorm);

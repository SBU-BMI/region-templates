...
int Segmentation::run() {
    ...
    int parameterId = ((ArgumentInt * )
    this->getArgument(0))->getArgValue();
    int parameterSegId = ((ArgumentInt * )
    this->getArgument(1))->getArgValue();
    unsigned char blue = (unsigned char) ((ArgumentInt * )
    this->getArgument(2))->getArgValue();
    unsigned char green = (unsigned char) ((ArgumentInt * )
    this->getArgument(3))->getArgValue();
    unsigned char red = (unsigned char) ((ArgumentInt * )
    this->getArgument(4))->getArgValue();
    double T1 = (double) ((ArgumentFloat * )
    this->getArgument(5))->getArgValue();
    double T2 = (double) ((ArgumentFloat * )
    this->getArgument(6))->getArgValue();
    unsigned char G1 = (unsigned char) ((ArgumentInt * )
    this->getArgument(7))->getArgValue();
    unsigned char G2 = (unsigned char) ((ArgumentInt * )
    this->getArgument(8))->getArgValue();
    int minSize = ((ArgumentInt * )
    this->getArgument(9))->getArgValue();
    int maxSize = ((ArgumentInt * )
    this->getArgument(10))->getArgValue();
    int minSizePl = ((ArgumentInt * )
    this->getArgument(11))->getArgValue();
    int minSizeSeg = ((ArgumentInt * )
    this->getArgument(12))->getArgValue();
    int maxSizeSeg = ((ArgumentInt * )
    this->getArgument(13))->getArgValue();
    int fillHolesConnectivity = ((ArgumentInt * )
    this->getArgument(14))->getArgValue();
    int reconConnectivity = ((ArgumentInt * )
    this->getArgument(15))->getArgValue();
    int watershedConnectivity = ((ArgumentInt * )
    this->getArgument(16))->getArgValue();

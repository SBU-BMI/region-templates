...
hadoopgisMetric="Dice+DiceNotCool"
testOnlyGis="true"
...
IMG_COUNTER=1
         while [  $IMG_COUNTER -lt 16 ]; do
             ...
             grep "hadoopgis-metric" ${outputPath}/${program}-${hadoopgisMetric}-NM-image${IMG_COUNTER}.txt > ${outputPath}/${program}-${hadoopgisMetric}-NM-image${IMG_COUNTER}-Metrics.txt
             #echo "Using PRO"

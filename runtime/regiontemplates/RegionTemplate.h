...
class RegionTemplate {
  ...
  public:
    ...
    DataRegion *getDataRegion(std::string drName, std::string drId = "",
                              int timestamp = 0, int version = 0);
    bool        deleteDataRegion(std::string drName, std::string drId = "",
                                 int timestamp = 0, int version = 0);
...
//	DataRegion *getDataRegion(std::string name, int version=0, int
// timestamp=0);

...
//KnnResult *KnnBounded::getKnnResult() {
//    return result;
//}

void  KnnBounded::callScript(std::string pathToScript, std::string pathToHadoopgisBuild, std::string maskFileName,
                             std::string referenceMaskFileName) {
    KnnBounded::executeScript(pathToScript, this->scriptName, pathToHadoopgisBuild, maskFileName,
                              referenceMaskFileName);

}

void KnnBounded::executeScript(std::string pathToScript, std::string scriptName, std::string pathToHgisBuild,
                               std::string maskFileName,
                               std::string referenceMaskFileName) {
    // Call the script passing the polygons as arguments
    // Sends 6 params:  1 - path to hadoopgis,

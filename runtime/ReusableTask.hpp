...
class ReusableTestTask: public ReusableTask {

public:
	ReusableTestTask() {};
	ReusableTestTask(list<ArgumentBase*> args, RegionTemplate* inputRt) {};

	bool reusable(ReusableTask* t) {return false;};

	// Write component data to a buffer
	int serialize(char *buff) {return 0;};

	// Initialize component data from a buffer generated by serialize function
	int deserialize(char *buff) {return 0;};

	ReusableTask* clone() {return NULL;};
